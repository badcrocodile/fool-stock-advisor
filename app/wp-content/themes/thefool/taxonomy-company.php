...
foolish_theme_debug( basename( __DIR__ ), pathinfo( __FILE__, PATHINFO_FILENAME ) );

use Fool\Connection;

$post_ticker = get_queried_object()->slug;

$profile = ( new Connection( $post_ticker, 'profile' ) )->getResponse();
$quote   = ( new Connection( $post_ticker, 'quote' ) )->getResponse();
?>
